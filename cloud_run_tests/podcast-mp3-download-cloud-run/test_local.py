...
# python -m pytest tests\test_local.py::test_keyword_query_string -s
def test_keyword_query_string():
    params={'collectionid':'1001',
            'episodeid': '10', 
            'mp3url': 'mp3url'}
...
#python -m pytest tests\test_local.py::test_keyword_query_string_fail_no_search_term -s
